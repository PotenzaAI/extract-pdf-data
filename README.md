...
### Converte um PDF em Markdown com imagens, realiza pós-processamento textual, envia as imagens para o Supabase Storage e reescreve o Markdown para apontar para as URLs públicas dessas imagens. Durante o processo, remove marcas d’água, a maioria das logos e imagens repetidas (ex.: cabeçalhos/rodapés). Pode operar lendo registros de URL/ID de uma tabela no Supabase e, ao final, enviar o Markdown processado para o próprio Supabase.



## Como funciona Leitura do PDF
...
Sim. Use o modo de URL única e omitindo os parâmetros de envio ao storage. Com --emit-file, o Markdown final será salvo localmente.
